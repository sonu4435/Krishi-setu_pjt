      ...
      <div className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-sm">
        ...
        <form className="mt-4 border-t border-gray-200">
          ...
          <ul role="list" className="px-2 py-3 font-medium text-gray-900">
            <li>
              <a href="#" className="block px-2 py-3">Resion</a>
            </li>
            <li>
              <a href="#" className="block px-2 py-3">Grade</a>
            </li>
            <li>
              <a href="#" className="block px-2 py-3">Rating</a>
            </li>
            <li>
              <a href="#" className="block px-2 py-3">Low to high Price</a>
            </li>
            <li>
              <a href="#" className="block px-2 py-3">high to low price</a>
            </li>
          </ul>
        </form >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  <input id="filter-mobile-category-2" name="category[]" value="travel" type="checkbox" checked className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
                    <label for="filter-mobile-category-2" className="ml-3 min-w-0 flex-1 text-gray-500">Quantity</label>
                </div>
                <div className="flex items-center">
