...
export default function Sidebar2({ ...props }) {
  return (
    <Sidebar {...props} width="250px !important">
      <Img src="/Fimages/img_group_18298.svg" alt="image" className="h-[30px] mt-6 ml-7 mr-[97px]" />
      <Menu
        menuItemStyles={{
          button: {
            padding: " ",
      ...
      >
        <div className="flex flex-row justify-start items-center w-full gap-2 p-2.5">
          <Img src="/Fimages/img_circlesfour_blue_gray_400.svg" alt="image_one" className="h-5 w-5 ml-5" />
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full pb-2.5 px-2.5">
            <div className="flex flex-row justify-start items-center mt-2.5 ml-[19px] gap-2">
              <Img src="/Fimages/img_group_2.svg" alt="image_two" className="h-4 w-4" />
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full pb-2.5 px-2.5">
            ...
            <Img src="/Fimages/img_arrow_right.svg" alt="arrowright" className="h-6 w-6 mb-[5px] cursor-pointer" />
          </div>
        </SubMenu>
        <div className="flex flex-row justify-start items-center w-full gap-2 p-2.5">
          <Img src="/Fimages/img_frame_20.svg" alt="vector_three" className="h-4 w-4 ml-[19px]" />
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full pt-2.5 px-2.5">
            <div className="flex flex-row justify-start items-center ml-[19px] gap-2">
              <Img src="/Fimages/img_frame_21.svg" alt="image_three" className="h-4 w-4" />
              <Text as="p">Table </Text>
            </div>
            <Img src="/Fimages/img_arrow_right.svg" alt="arrowright_five" className="h-6 w-6 mt-[13px] cursor-pointer" />
          </div>
        </SubMenu>
      </Menu>
